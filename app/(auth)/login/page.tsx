  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-100 px-6 py-10">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">Gunakan kredensial Supabase Auth untuk mengakses area operasional bisnis, termasuk POS, klinik, dan laporan.</p>
        ...
        <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm text-slate-600">
          <p className="font-medium text-slate-800">Catatan akses</p>
          <p className="mt-1">Owner, dokter, dan staff mendapatkan modul sesuai peran masing-masing.</p>
        </div>
